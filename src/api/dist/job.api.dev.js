  ...
  return regeneratorRuntime.async(function getJobs$(_context3) {
    while (1) {
      switch ((_context3.prev = _context3.next)) {
        case 0:
          (_ref = _args3.length > 0 && _args3[0] !== undefined ? _args3[0] : {}),
          ...
          return regeneratorRuntime.awrap(
            _axios["default"].get("/search/job?".concat(params.toString()))
          );
    ...
    while (1) {
      switch ((_context5.prev = _context5.next)) {
        case 0:
          ...
          _context5.next = 3;
          return regeneratorRuntime.awrap(
            _axios["default"]["delete"]("/remove/job", {
              data: {
                jobId: jobId,
                userId: userId,
              },
    ...
    while (1) {
      switch ((_context6.prev = _context6.next)) {
        case 0:
          _context6.next = 2;
          return regeneratorRuntime.awrap(
            _axios["default"].get("/get/save/job?id=".concat(userId))
          );
      ...
      switch ((_context8.prev = _context8.next)) {
        case 0:
          (userId = _ref4.userId),
            ...
            (limit = _ref4$limit === void 0 ? 10 : _ref4$limit);
          params = new URLSearchParams();
          ...
          _context8.next = 7;
          return regeneratorRuntime.awrap(
            _axios["default"].get("/get/applied/job?".concat(params.toString()))
          );
    ...
    while (1) {
      switch ((_context10.prev = _context10.next)) {
        case 0:
          ...
          _context10.next = 3;
          return regeneratorRuntime.awrap(
            _axios["default"].put("/update/job?jobId=".concat(jobId, "&status=").concat(status))
          );
