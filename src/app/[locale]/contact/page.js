        ...
        <>
            ...
            <main className="relative">
                <div className="py-12 px-6">
                    <div className="max-w-3xl mx-auto bg-white shadow-sm border border-slate-300 rounded-lg p-8 ">
                        <h2 className="text-sm sm:text-3xl font-extrabold text-gray-900 text-center mb-4">
                            {t("title")}
                        </h2>
