      ...
      <div className="flex gap-2">
        {["upcoming", "past"].map((tab) => (
          <button
            ...
            className={`flex items-center gap-2 rounded-md px-4 py-2 text-[13px] font-medium shadow-md ${activeTab === tab
      ...
      <div className="mt-4">
        <div className="rounded-lg bg-white shadow-md">
          {interviews.map((interview, index) => (
            ...
            >
              <div className="block">
                <h3 className="text-[14px] font-medium">{interview?.userId?.profile?.fullName}</h3>
                <p className="text-sm text-gray-500">{interview?.userId?.preferences?.jobRole}</p>
              </div>
