      ...
      {applicants.map((applicant) => {
        ...
        return (
          <div
            ...
            className={`flex cursor-pointer flex-col border-b border-gray-100 p-4 transition-colors duration-150 hover:bg-gray-100 sm:flex-row sm:items-center sm:justify-between ${selectedApplicant?._id === applicant._id
          ...
          >
            <div className="flex-1">
              <h3
                className={`text-[15px] font-medium ${selectedApplicant?._id === applicant._id ? "font-bold text-[#0a66c2]" : ""
                  }`}
              >
