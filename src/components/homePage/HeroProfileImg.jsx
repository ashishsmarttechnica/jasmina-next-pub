  ...
  return (
    <section className="mx-2 mt-5 mb-10 sm:mx-0 lg:mb-32 xl:mt-14 2xl:mb-0">
      <div className="mx-0 max-w-[1520px] px-5 xl:mx-auto">
        <div className="grid grid-cols-2 items-end justify-items-center gap-4 sm:grid-cols-3 sm:gap-6 md:grid-cols-3 lg:grid-cols-5 lg:gap-6">
          <div className="relative lg:top-28 2xl:end-10">
            <Image
              ...
              width={104}
              height={104}
              className="rounded-xl object-cover shadow-[0_10px_20px_rgba(0,_0,_0,_0.3)] xl:h-[104px] xl:w-[104px]"
            />
          </div>
          ...
          <div className="relative lg:top-0 2xl:end-20">
            <Image
              ...
              width={180}
              height={180}
              className="rounded-xl object-cover shadow-[0_10px_20px_rgba(0,_0,_0,_0.3)] xl:h-[180px] xl:w-[180px]"
            />
          </div>
          ...
          <div className="relative lg:top-28 2xl:start-10">
            <Image
              ...
              width={104}
              height={104}
              className="object-end rounded-xl object-cover shadow-[0_10px_20px_rgba(0,_0,_0,_0.3)] xl:h-[104px] xl:w-[104px]"
            />
          </div>
        </div>
      </div>
